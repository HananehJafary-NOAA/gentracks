...
sort -u ${PERTDATA}/genvitals.${atcfout}.${regtype}.${PDY}${CYL} > ${PERTDATA}/out_sort
mv ${PERTDATA}/out_sort ${PERTDATA}/genvitals.${atcfout}.${regtype}.${PDY}${CYL}
     ...
     if [ ${SENDCOM} = 'YES' ]; then
        ...
        if [ ${PARAFLAG} = 'YES' ]; then
         echo " "
              ...
              cp ${PERTDATA}/trak.${atcfout}.atcf_gen.${regtype}.${PDY}${CYL}  ${COMOUT_dailyTRK}
              cp ${PERTDATA}/trak.${atcfout}.atcfunix.${regtype}.${PDY}${CYL} ${COMOUT_dailyTRK}/${atcfout}.t${CYL}z.cyclone.trackatcfunix.${regtype}
              cp ${PERTDATA}/trak.${atcfout}.radii.${regtype}.${PDY}${CYL} ${COMOUT_dailyTRK}/${atcfout}.t${CYL}z.cyclone.radii.${regtype}

##G.P. Lou
## Moved this part to "genesis_tracker_poe.sh" due to multiple CPU usage.
##              if [ $regtype = "glbl" ] ; then
##                cat ${COMOUT_dailyTRK}/${atcfout}.t${CYL}z.cyclone.trackatcfunix.${regtype} >> ${COMOUT_dailyTRK}/cyclone_${PDY}${CYL}.ens
##                 if [ $SENDDBN = "YES" ] ; then
